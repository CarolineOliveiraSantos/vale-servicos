...
export const PtBr: Translation = {
  ...
  continue: 'Continue',
  doNotHaveARegistrationYet: 'Ainda não possui cadastro?',
  register: 'Cadastre-se',
  password: 'Senha',
  enterYourEmail: 'Informe o seu email',
  pleaseProvideAValidEmail: 'Informe um email válido',
  mustHaveAtLeast6Characters: 'Deve ter no mínimo 6 caracteres',
  enterYourPassword: 'Informe sua senha',
}
