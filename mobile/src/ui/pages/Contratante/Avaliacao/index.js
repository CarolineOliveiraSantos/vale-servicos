...
const Avaliacaoo = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>Avaliações deste serviço</Text>
          ...
          <View keyExtractor={(avaliacao) => String(avaliacao.id)}>
            <View style={styles.descriptionContainerr}>
              <Text style={styles.descriptionn}>
                Avaliador:{' '}
                <Text style={styles.dataValuee}>{avaliacao.nome}</Text>
              </Text>
              <Text style={styles.descriptionn}>
                Nota: <Text style={styles.dataValuee}>{avaliacao.nota}</Text>
              </Text>
              <Text style={styles.descriptionn}>
                Comentário:{' '}
                <Text style={styles.dataValuee}>{avaliacao.comentario}</Text>
              </Text>
            </View>
          </View>
        ))}
